  ...
  def render(assigns) do
    ...
    <div class="p-8">
      ...
      <div class="space-y-10">
        <%!-- 8-Ball --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("8-Ball")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
        ...
        <%!-- 9-Ball --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("9-Ball")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
        ...
        <%!-- 10-Ball --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("10-Ball")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
        ...
        <%!-- Straight Pool --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("Straight Pool")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
        ...
        <%!-- One Pocket --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("One Pocket")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
        ...
        <%!-- Snooker --%>
        <div>
          <h2 class="text-2xl font-semibold mb-2 dark:text-white">{gettext("Snooker")}</h2>
          <p class="text-gray-700 mb-4 dark:text-white">
