    ...
    <!-- Images -->
      <section class="bg-gray-50 p-6 rounded-lg shadow-md dark:bg-gray-700 dark:text-white">
        <div class="flex items-center justify-center gap-2 mb-4">
          ...
          <img src={~p"/images/final/decorative-wave-2.png"} alt=""  class="h-6 w-6 block dark:hidden" />
          <img src={~p"/images/final/decorative-wave-white-2.png"} alt="" class="h-6 w-6 hidden dark:block" />
        </div>
        <.carousel />
      </section>
