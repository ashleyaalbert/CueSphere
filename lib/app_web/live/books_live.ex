    ...
    <div class="mt-8 bg-white shadow-lg rounded-xl p-6 md:p-10 dark:bg-gray-800 dark:text-gray-200">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6">
        ...
        <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
          <img src={~p"/images/book1.jpg"} alt="Life Through Pool Book Cover" class="w-24 h-32 object-cover rounded-md shadow" />
          <div>
            <h3 class="text-lg font-semibold text-blue-900 dark:text-white">Life Through Pool</h3>
        ...
        <!-- Book 2 -->
        <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
          <img src={~p"/images/book2.jpg"} alt="The 99 Critical Shots in Pool: Everything You Need to Know to Learn and Master the Game Book Cover" class="w-24 h-32 object-cover rounded-md shadow" />
          <div>
            <h3 class="text-lg font-semibold text-blue-900 dark:text-white">The 99 Critical Shots in Pool: Everything You Need to Know to Learn and Master the Game</h3>
            <p class="text-sm text-gray-800 dark:text-gray-300 mb-2">
            ...
            <ul class="list-disc list-inside text-sm text-gray-800 dark:text-gray-300 mb-2">
              <li>The Center Ball Cheat-the-Pocket</li>
              <li>The Hook Shot</li>
              <li>The Seven Ball Stop Shot</li>
              <li>The Jump Shot</li>
              <li>The Frozen Kiss Shot</li>
              <li>The Nudge Shot</li>
              <li>The Side Pocket By-Pass Shot</li>
            </ul>
        ...
        <!-- Book 3 -->
        <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
          <img src={~p"/images/book3.jpg"} alt="Pool and Billiards For Dummies Book Cover" class="w-24 h-32 object-cover rounded-md shadow" />
          <div>
            <h3 class="text-lg font-semibold text-blue-900 dark:text-white">Pool and Billiards For Dummies</h3>
            <p class="text-sm text-gray-800 dark:text-gray-300 mb-2">
            By Nicholas Leider - Practical, step-by-step tips for players of all levels
        ...
        <!-- Book 4 -->
        <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
          <img src={~p"/images/book4.jpg"} alt="A Mind for Pool: How To Master The Mental Game Book Cover" class="w-24 h-32 object-cover rounded-md shadow" />
          <div>
            <h3 class="text-lg font-semibold text-blue-900 dark:text-white">A Mind for Pool: How To Master The Mental Game</h3>
            <p class="text-sm text-gray-800 dark:text-gray-300 mb-2">
