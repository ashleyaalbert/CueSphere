      ...
      <div class="mt-8 bg-white shadow-lg rounded-xl p-6 md:p-10 dark:bg-gray-800 dark:text-gray-200">
        <div class="mt-6 grid grid-cols-1 gap-6">
          ...
          <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
            <img
              src={~p"/images/final/book1.jpg"}
              alt={gettext("Life Through Pool Book Cover")}
    ...
    <!-- Book 2 -->
          <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
            <img
              ...
              alt={
                gettext(
                  "The 99 Critical Shots in Pool: Everything You Need to Know to Learn and Master the Game Book Cover"
                )
              }
              class="w-24 h-32 object-cover rounded-md shadow"
            />
    ...
    <!-- Book 3 -->
          <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
            <img
              ...
              alt={gettext("Pool and Billiards For Dummies Book Cover")}
              class="w-24 h-32 object-cover rounded-md shadow"
            />
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
    ...
    <!-- Book 4 -->
          <div class="flex items-start space-x-4 bg-gray-200 p-4 rounded-lg dark:bg-gray-700">
            <img
              ...
              alt={gettext("A Mind for Pool: How To Master The Mental Game Book Cover")}
              class="w-24 h-32 object-cover rounded-md shadow"
            />
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
