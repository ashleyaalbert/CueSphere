defmodule AppWeb.ItemLiveTest do
  ...
  import App.ItemsFixtures

  @create_attrs %{attributes: 42, name: "some name"}
  @update_attrs %{attributes: 43, name: "some updated name"}
  @invalid_attrs %{attributes: nil, name: nil}
